...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/spring-morning-dc9c)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/spring-morning-dc9c#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/spring-morning-dc9c
```

A live public deployment of this template is available at [https://spring-morning-dc9c.templates.workers.dev](https://spring-morning-dc9c.templates.workers.dev)
